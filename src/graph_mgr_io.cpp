...
#include <pcl/filters/voxel_grid.h>//selbst hinzugefügt
...
void GraphManager::saveAllCloudsToFile(QString filename){
    ...
    aggregate_cloud.header.frame_id = base_frame;
        ...
        /////////////////////////////////////////////////////////////////////////////////////////
        //SELBST GESCHRIEBEN!!!
        pcl::PointCloud<pcl::PointXYZRGB> cloud_converted;// (new pcl::PCLPointCloud2 ());
        pcl::PointCloud<pcl::PointXYZRGB> cloud_filtered;// (new pcl::PCLPointCloud2 ());
        pcl::VoxelGrid<pcl::PointXYZRGB> filter;
        filter.setInputCloud (aggregate_cloud.makeShared()); // macht einen Pointer aus/ auf aggregate_cloud
        filter.setLeafSize (0.022f, 0.022f, 0.022);
    ...
    if(filename.endsWith(".pcd", Qt::CaseInsensitive))
      pcl::io::savePCDFile(qPrintable(filename), cloud_filtered, true); //Last arg is binary mode
    else {
